    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" class="row g-3" enctype="multipart/form-data" id="eventEditForm">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-6 mt-2 p-2">
                         ...
                         <div class="col-md-6 mt-2 p-2">
                            <div class="form-group">
                                ...
                                <input type="date" id="event_date" class="form-control datepicker" name="event_date" />
                            </div>
                        </div>
