                ...
                <div class="row g-5">
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="d-flex pt-2">
                            <a class="btn btn-outline-light btn-social" href="{{$institute->social_link2}}"><i class="fab fa-twitter"></i></a>
                            ...
                            <a class="btn btn-outline-light btn-social" href="{{$institute->social_link3}}"><i class="fab fa-linkedin-in"></i></a>
                        </div>
                    </div>
